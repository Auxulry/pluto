            ...
            <div className='flex flex-row items-center border-b border-black'>
              ...
              <div className='w-full min-w-[589px] border-super-slim-l flex flex-col gap-0.5'>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>1</div>
                ...
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>2</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>3</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>4</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>5</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>6</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
              </div>
            ...
            <div className='flex flex-row items-center border-b border-black'>
              ...
              <div className='w-full min-w-[589px] flex flex-col gap-0.5'>
                <div className='flex flex-row items-center gap-1'>
                  ...
                  <div className='flex flex-row'>
                    <div className='border-2 border-black w-[20px] h-[30px] text-center'>7</div>
                    <div className='border-super-slim-t border-super-slim-b w-[231px] h-[30px] text-center'></div>
                  </div>
                </div>
                <div className='flex flex-row items-center gap-1'>
